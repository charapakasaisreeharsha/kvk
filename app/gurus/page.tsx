...
const gurus: Guru[] = [
  ...
  {
    name: { en: "Brahmasri Kuppa Subrahmanya Sastry garu", te: "బ్రహ్మశ్రీ కుప్పా సుబ్రహ్మణ్య శాస్త్రిగారు" },
    group: { en: "Educational Guru", te: "విద్యాగురువు" },
    body: { en: "The second elder brother of Kuppa Venkata Krishnamurthy garu, Sri Subrahmanya Sastry garu was a man of profound detachment and exceptional intellectual power. Though he held an M.Sc. in Applied Mathematics and served the Water Works Department, his interests ranged across ancient and modern knowledge. A lifelong debating counterpart, he demonstrated that ideas considered modern were already rooted in the Sanatana tradition, and he remained a guiding star in difficult times.", te: "వీరు కుప్పావేంకట కృష్ణమూర్తిగారి రెండవ అన్నగారు. మట్టిలోని మాణిక్యంగా మిగిలిపోవటమే జీవన వ్రతంగా పెట్టుకొన్న వైరాగ్యనిధి. చదివింది Applied Mathematics లో M.Sc అయినా, తన పనితీరుతో మెరుగులు దిద్దినది అప్పటి A.P. PWD లోని Water works శాఖకు! కుప్పావేంకట కృష్ణమూర్తిగారికి వీరు చిన్నప్పటినుంచే నిత్యవాద ప్రతిద్వంది. అత్యాధునికమని కుప్పావేంకట కృష్ణమూర్తిగారరు భావించినవన్నీ సనాతనంలోనే ఉన్నాయని నిరూపించిన బోధకుడు! అతిథి సత్కారాన్ని అనంత సౌభాగ్యంగా భావించే యీ అన్నగారు కుప్పావేంకట కృష్ణమూర్తిగారికి అనేక సంకట సన్నివేశాలలో వినూత్న మార్గదర్శనాలు చేసిన ధ్రువతార !!!" },
