...
const childrenFamilies: ChildFamily[] = [
  {
    ...
    coupleTe: "కుప్పా కార్తికేయ శర్మ & లక్ష్మీ శైలజ",
  },
  {
    photo: "/family/son-2.png",
    label: "son2",
    coupleEn: "Kuppa Viswanatha Sharma & Tara",
    coupleTe: "కుప్పా విశ్వనాథ శర్మ & తార",
  ...
  },
  {
    ...
    coupleTe: "కుప్పా శ్రీ గురు బిల్వేష శర్మ & నాగ శ్రావణి",
  ...
  },
  {
    ...
    coupleTe: "కుప్పా నరసింహ & యజ్ఞప్రియ",
    kidsEn: "Puruhutika",
    kidsTe: "పురుహూతిక",
  },
  {
